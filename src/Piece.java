...
public abstract class Piece{
    ...
    Precondition: 99 is Color.WHITE and this is a block,OR
    0 is Color.RED, 1 is Color.GREEN, or 2 is Color.YELLOW.
    also change the colorId */
	public void setColor(int c){
		colorID = c;
		if (c == 0) color = Color.RED;
		else if (c == 1 )color = Color.GREEN;
		else if (c == 2 )color = Color.YELLOW;
		else if (c == 99 )color = Color.WHITE;
